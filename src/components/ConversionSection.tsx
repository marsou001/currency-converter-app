...
export default function ConversionSection(props: ConversionSectionProps) {
  ...
  return (
    <div className='relative min-h-10 border border-gray-300 rounded-lg'>
      {props.isFetchingRate ? <LoaderDots /> : <input type='text' inputMode="decimal" pattern="\d+(\.)?\d*" value={props.amount} onChange={onAmountChange} className='text-lg font-bold w-full py-2 pl-8 border-nonerounded-lg' />}
